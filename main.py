...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ" ,url=f"https://t.me/+Dk-Y2s9WubQ2MTkx") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/Medicoarmy") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/+Dk-Y2s9WubQ2MTkx")
                ],
            ]
      )
...
image_urls = [
    "https://graph.org/file/00fe5ef07ceff54253200-df5a664d2a1aa2cf6c.jpg",
...
async def upload(bot: Client, m: Message):
    ...
    if thumb.startswith("http://") or thumb.startswith("https://"):
        ...
        print("⚠️ Invalid input, using auto-generated thumbnail")
                ...
                # Process complete hone ke baad wala final message
    await m.reply_text(
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            try:
                ...
                # Baki sabhi format ke liye same template
                cyt = cc
                cpvod = cc
                cimg = cc
                cczip = cc
